Public Class Enemies
    ...
    Public Shared ReadOnly Enemy As InitEnemy() = {'0 Common 1 Ice 2 Fire 3 Water 4 Grass 5 Star 6 Metal 7 Electric 8 Shadow
        ...
        New InitEnemy(0, LangStr.s_enemy(10, MainForm.langID), 135, 135, 41, 22, 0.7, 0.65, 78, 49),'5~10 R1, 2~10
        ...
        New InitEnemy(8, LangStr.s_enemy(12, MainForm.langID), 945, 945, 112, 29, 0.25, 0.75, 212, 135),
        New InitEnemy(0, LangStr.s_enemy(13, MainForm.langID), 2306, 2306, 165, 102, 0.485, 1.125, 563, 809),
        New InitEnemy(1, LangStr.s_enemy(13, MainForm.langID), 2306, 2306, 165, 102, 0.485, 1.125, 563, 809),
        New InitEnemy(2, LangStr.s_enemy(13, MainForm.langID), 2306, 2306, 165, 102, 0.485, 1.125, 563, 809),
        New InitEnemy(3, LangStr.s_enemy(13, MainForm.langID), 2306, 2306, 165, 102, 0.485, 1.125, 563, 809),
        New InitEnemy(4, LangStr.s_enemy(13, MainForm.langID), 2306, 2306, 165, 102, 0.485, 1.125, 563, 809),
